  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        ...
        {
          headers: {
            Authorization: `${localStorage.getItem("token")}`, // Use Bearer token format
